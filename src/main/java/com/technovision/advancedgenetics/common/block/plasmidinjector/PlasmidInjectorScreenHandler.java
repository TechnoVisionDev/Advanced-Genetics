...
public class PlasmidInjectorScreenHandler extends AbstractGeneticsScreenHandler {
    ...
    public PlasmidInjectorScreenHandler(int syncId, Inventory playerInventory, BlockPos pos) {
        this(syncId, playerInventory, Objects.requireNonNull(playerInventory.player.level().getBlockEntity(pos)), new SimpleContainer(PlasmidInjectorBlockEntity.SLOT_COUNT), new SimpleContainerData(5));
    }
